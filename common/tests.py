...
class TestCommon(TestCase):
    ...
    def test_fail_remove_player(self):
        common.add_player_to_team(user=self.player1, player=self.player1, season=self.season_open, team=self.team)
        common.add_player_to_team(user=self.player2, player=self.player2, season=self.season_open, team=self.team)
    ...
    def test_fail_player_season_perm(self):
